                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 space-y-6">
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                    {allJobPhotos.map((photo) => {
                      ...
                      return (
                        <div key={photo._id} className={`border-2 rounded-xl overflow-hidden bg-white shadow-sm transition-all flex flex-col ${
                          isSelected ? 'border-blue-500 ring-4 ring-blue-50' : 'border-slate-200 opacity-75'
                        }`}>
                          <div className="relative aspect-[4/3] bg-slate-100">
                            ...
                            <div className="absolute bottom-2 right-2">
                              <button 
                                ...
                                className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-lg shadow-md transition-all ${
                                  isSelected ? 'bg-blue-600 text-white' : 'bg-white text-slate-700 border border-slate-300'
                                }`}
                              >
                    ...
                    <div key={idx} className="flex items-start gap-3">
                      <div className="flex flex-col items-center">
                        <div className={`w-4 h-4 rounded-full flex items-center justify-center text-[8px] font-black ${
                          isActive ? `${step.color} text-white` : isPassed ? 'bg-slate-800 text-white' : 'bg-slate-200 text-slate-400'
                        }`}>
                          {idx + 1}
                        </div>
