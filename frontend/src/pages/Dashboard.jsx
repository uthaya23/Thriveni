          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
            ...
            <div className="space-y-3">
              {criticalJobs.length > 0 ? criticalJobs.map(job => (
                <div key={job._id} onClick={() => navigate(`/jobs/${job._id}`)} className="p-3 border border-red-100 rounded-lg bg-red-50 hover:bg-red-100 cursor-pointer transition-colors border-l-4 border-l-red-500">
