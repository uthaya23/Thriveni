...
import { FiHome, FiList, FiDatabase, FiUser, FiLogOut, FiSettings, FiUsers, FiBox, FiLayout, FiChevronDown, FiGrid, FiActivity, FiCode, FiCalendar } from 'react-icons/fi';
...
const DESKTOP_MORE = [
  { to: '/monthly-report',     icon: FiCalendar,   label: 'Monthly Report',end: false },
  { to: '/production-planning',icon: FiLayout,     label: 'Planning',    end: false, notTechnician: true },
  { to: '/inventory',          icon: FiBox,        label: 'Inventory',   end: false, notTechnician: true },
